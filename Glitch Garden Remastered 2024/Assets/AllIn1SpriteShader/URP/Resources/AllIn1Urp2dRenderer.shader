Shader "AllIn1SpriteShader/AllIn1Urp2dRenderer"
{
    Properties
    {
		...
		_MaskTex("Lighting Mask", 2D) = "white" {} //169
		_LitAmount("Lit Amount",  Range(0,1)) = 1 //170
		_NormalMap("Normal Map", 2D) = "bump" {} //171
		_NormalStrength("Normal Strength",  Range(0,10)) = 1 //172
		[Toggle()] _GlowAffectLight("Glow affects light", Float) = 1 //173
